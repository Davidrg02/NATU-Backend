...
async function one(req, res, next) {
    try {
        const direccion = await controller.one(req.params.id);
...
async function insert(req, res, next) {
    try {
        const direccion = await controller.insert(req.body);
...
async function update(req, res, next) {
    try {
        const direccion = await controller.update(req.params.id, req.body);
...
async function remove(req, res, next) {
    try {
        const direccion = await controller.remove(req.params.id);
